...
const dikstra = (cave, qMap, settled, unsettled, unsettledIndexes) => {
  while (unsettled.length > 0) {
    let parent = unsettled.pop();
    unsettledIndexes = unsettledIndexes.filter(remove => remove.index != parent.index)
...
const setupDjikstra = (cave, size) => {
  ...
  let unsettledIndexes = new Array();
  ...
  return [qMap, settled, unsettled, unsettledIndexes]
}
...
const part1 = (input) => {
  ...
  let [qMap, settled, unsettled, unsettledIndexes] = setupDjikstra(cave, size)

  dikstra(cave, qMap, settled, unsettled, unsettledIndexes);
...
const part2 = async(input) => {
  ...
  let [qMap, settled, unsettled, unsettledIndexes] = setupDjikstra(bigCave, bigSize)

  c2s(bigCave)
  console.log("Got big cage doing dik")
  dikstra(bigCave, qMap, settled, unsettled, unsettledIndexes);
